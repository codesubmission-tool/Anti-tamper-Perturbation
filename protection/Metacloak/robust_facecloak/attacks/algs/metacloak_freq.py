...
def main(args):
    ...
    def load_config(config_file):
        ...
        return config
    config = load_config(os.path.abspath('../../../configs/protection.yaml'))
    ...
    def save_image(perturbed_data, id_stamp):
        ...
        # print(list(Path(args.instance_data_dir_for_adversarial).iterdir()))
        img_names = [
        ...
        for model_i in range(num_models):
            ...
            for split_step in steps_list: 
                ...
                for j in range(args.interval // args.advance_steps):
                    ...
                    perturbed_data = defender.perturb_freq(f, perturbed_data, original_data, vae, tokenizer, noise_scheduler,config )
